...
export const PointsHistory = ({ datesData }) => {
            ...
            <div className="overflow-x-auto">
                <table className="min-w-full bg-white border-collapse">
                    ...
                    <tr className="bg-gray-50">
                        ...
                        <th className="p-4 text-sm font-semibold text-gray-700 border-b-2 border-black">Achieved points</th>
                        <th className="p-4 text-sm font-semibold text-gray-700 border-b-2 border-black">Available points</th>
                    </tr>
                    </thead>
                    <tbody>
